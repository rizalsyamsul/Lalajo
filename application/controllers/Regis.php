...
class Regis extends CI_Controller
{
    ...
    /**
     * Memuat model 'M_Auth' yang akan dibutuhkan ketika user melakukan register
     */
    ...
    /**
     * Melakukan validasi form dengan syarat-syarat yang dibutuhkan ketika user melakukan register.
     * Ketika inputan user sudah sesuai, maka data akan di inputkan ke database
     * dan mengeluarkan output bahwa user berhasil register.
     */
